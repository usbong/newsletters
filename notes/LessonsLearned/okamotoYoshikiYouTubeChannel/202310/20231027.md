...
But first, why take on the challenge of working on Web3, which is full of people who don't seem to know what it's about, instead of super high-tech consumer and online games?
...
"We don't need gameplay.", "This mobile app is not a game, but a money-collecting machine.", "No need to think about anything. Just copy our way of doing things."
...
Despite having valued this idea above anything else, I began to feel that it was sacrilegious to gaming, because it couldn't comply with the rules that those people created. I do still remember my anger at this realization. 

> 日本のゲーム業界は、それらのルールで“足止め”させられたせいで、成長が3年は遅れたと思っています。

Within the Japanese gaming industry, the rules that they had created had I think delayed our growth for 3 years, because of what is known as "stopped in our tracks."

> 特にゲーム業界はほかの業界と比べ、ドッグイヤー（変化のスピードが速い）業界だといわれています。つまり、一般基準でいえば、ゲームは20年ぐらい成長が遅れた計算になるわけです。致命的ですよね。

In particular, when comparing the gaming industry with another's, it's been called the dog-years world, because the speed of change is fast. This means that, speaking in general terms, we could compute that the growth of the gaming industry has been delayed by about 20 years. This is lethal.

> 市場を握っていたのは先発組で、後発組となった僕たちは、彼らのルールで開発を強いられました。どの業界もそうですが、その大陸を最初に開拓した人や企業が「基準」になります。

We in the later group are forced to work on development using the rules that the earlier group who had seized the market created. While this may be true in whichever industry, the people and the businesses who had first opened up that territory for development create the "standard".

> あとから来た者がそこに異を唱えても、まったく相手にされません。
ある程度成功したから、ゲーム業界のこれからを照らしたい

And even if the later people voice out their complains, they won't be heard. To a certain extent, we've succeeded in the gaming industry, and it is for this reason that I'd want to shed light on the future of this industry.
...
Of course, I'd want to stop this new Web3 territory from becoming only a profit-making device for many of its users in the gaming industry. If it were me, I'd be creating something more interesting, something that more users could enjoy, and in which game creators can unleash more of their energies. 
...
I've succeeded to a certain extent in the gaming industry. And I have also acquired a sufficient amount of money to live a decent life until I die.
...
In the succeeding parts, I'll be talking a little bit more in detail about my future plans which I'd like to realize using Web3, as well as the details of "TEKKON", a grandiose game that contributes to waterworks infrastructure maintenance.
