...
While ending up with that tutorial (superbly complete, certainly, raises the salary of whomever had the idea to accompany the action with a metronome), its absence from the first moment of engagement into combat may perhaps be the most evident, and intentional statement from a franchise that has always been viewed with the most or least success between two radically different players:
...
those who long to watch its name displayed on the title screen with an Arcade Stick, and those who only want to mash buttons, while asking for some pizzas from Eddy who does arrive with some.
...
This 8th entry accepts and embraces those two, and their two equal ways of playing and understanding Tekken, and it is because of this that those few seconds may get us up and celebrating because of the inclusion of a powerfully done mode of a guide that solves in those first few beats the problem of the little paper guides given to the newcomer:
...
it can be activated and deactivated quite simply with a mere push of a button, and like in a similar way seen in other franchises, its function reduces the most complex commands into trivial button presses.
...
As it is, mashing the triangle button to unleash a multitude of aerial combos and the square to exploit free magic was relatively simple to advance with those first beats the story as if it's more than a movie, and at times it did seem to be more than what they intended. Because at times its story mode appears much like a film.
