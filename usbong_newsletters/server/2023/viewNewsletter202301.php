...
<table class="noteTable">
	<tr>
		...
		<td class="noteTableTextColumn">
			...
			<br/>
			In this case, the <b>COMPUTER</b> provides noticeable assistance, due to the <b>TOTAL</b> items in the LIST is <b>over 1000</b>.<br/>
			<br/>
			A <b>HUMAN</b> can attempt to do this task, but we can <b>expect</b> that doing this <b>ACTION multiple times each day</b> shall cause <b>ERRORS</b> in the <b>OUTPUT</b>.<br/>
			<br/>
			EXAMPLE: <b>INCORRECT `item_total_sold`</b>	
		</td>
	</tr>
</table>
<br/>
