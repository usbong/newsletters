...
<h4>1.1) shared: know-how to combine multiple <b>MySQL Database (DB)</b> Tables using spreadsheet tool, LibreOffice Calc,</h4>
--> where:  LibreOffice Calc file can also be opened using MS EXCEL

<h5><b>Example MYSQL COMMAND:</b></h5>
...
--> to be auto-generated using LibreOffice Calc,<br/>
--> where: the <b>COLUMN</b> values are auto-updated<br/>
--> notes: <b>NULL</b> value due to already auto-generated by <b>MySQL DB</b><br/>
...
<table class="noteTable">
	<tr>
		...
		<td class="noteTableTextColumn">
			...
			<b>JOIN</b>ED together in the <b>MySQL DB COMMAND</b>.<br/>
			<br/>
			...
			EXAMPLE?<br/>
			<br/>
			<b>Technique used to quickly COMBINE?</b> 
