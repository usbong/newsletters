<!--
  ...
  @date updated: 20250726; from 20250725
...
*/		  
		  ...
		  var summaryReportsHeaderId = document.getElementById("summaryReportsHeaderId"+sParamId.substring("summaryReportsHeaderId".length));
			  ...
			  //added by Mike, 20250726
			  //sCurrText=;
			  //alert(window.location.href);
			  
			  sWindowLocationHref=window.location.href;
			  
			  //TODO: -add: update language in URL when changed

	//TODO: -update: this	
			  if (sWindowLocationHref.indexOf("?")!=-1) {
				  sCurrText = sWindowLocationHref.substring(sWindowLocationHref.indexOf("?")+1); //"?" not included
				  
				  sCurrTextArray = sCurrText.split("-");
				  sSelectedRow = sCurrTextArray[0];
				  
				  //sCurrText=sSelectedRow+"-EN";
				  
				  //alert(sSelectedRow);
				  
				  //iNewsRankCount
				  //myLanguageChangeFunction(sSelectedRow,sCurrTextArray[1]);
...
*/						
			  ...
			  if ((currSummaryReportsId!==null) && (currSummaryReportsHeaderId!==null)) {				  
				  ...
				  if (currSummaryReportsHeaderId.style.display === "") {
					  ...
					  //alert(sLanguageTemp);
					  //edited by Mike, 20250726
					  //location.reload();
					  //window.location.href = location.href;
					  //sWindowLocationHref=window.location.href;
					  
					  if (sWindowLocationHref.indexOf("?")!=-1) {
						  sWindowLocationHref = sWindowLocationHref.substring(0,sWindowLocationHref.indexOf("?"));
					  }
					  
					  window.location.href = sWindowLocationHref+"?"+sCurrText;
