﻿<!--
  ...
  Input:  
  1) https://www.itpec.org/pastexamqa/ip.html; last accessed: 20230815; ITPEC
  
  Output:
  1) Usbong PhilNITS viewable using Computer/Mobile Web Browsers  
  
  Computer Browser: Website Address (Example):
  1) local: http://localhost/usbong_newsletters/server/usbongPhilnits.php
  2) public internet: http://store.usbong.ph/server/usbongPhilnits.php
...
//	$result = array();
	$sYearDirectory="/server/philnits/2022A_IP/Q1-20230815/";
